...
if __name__ == "__main__":
    ...
    # Arguments for multi-model support
    parser.add_argument("--attacker_port", type=str, default=None, help="Port for locally hosted attacker model (e.g., 8000)")
    parser.add_argument("--target_port", type=str, default=None, help="Port for locally hosted target model (e.g., 8001)")
    parser.add_argument("--api_key", type=str, default=None, help="API key for local models (default: use LOCAL_API_KEY)")
